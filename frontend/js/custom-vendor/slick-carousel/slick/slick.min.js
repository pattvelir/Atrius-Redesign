...
!(function(a) {
  ...
  (b.prototype.autoPlayIterator = function() {
    ...
    a.paused ||
        ...
        (a.options.infinite === !1 &&
          (a.direction === 1 && a.currentSlide + 1 === a.slideCount - 1
            ? (a.direction = 0)
            : a.direction === 0 &&
              ((b = a.currentSlide - a.options.slidesToScroll),
    ...
    if (
      (a.type(arguments[0]) === "object"
        ...
        : a.type(arguments[0]) === "string" &&
            ...
            (f = arguments[1]),
            (g = arguments[2]),
            arguments[0] === "responsive" && a.type(arguments[1]) === "array"
              ? (h = "responsive")
  ...
  (b.prototype.setProps = function() {
    ...
    (a.transformsEnabled =
          a.options.useTransform && a.animType !== null && a.animType !== !1);
  }),
    ...
    if (
      !(
        b.options.swipe === !1 ||
          ...
          (b.options.draggable === !1 && a.type.indexOf("mouse") !== -1)
      )
    )
      switch (
        ...
        e !== "vertical"
          ...
          b.options.infinite === !1 &&
                  ((b.currentSlide === 0 && e === "right") ||
                    (b.currentSlide >= b.getDotCount() && e === "left")) &&
