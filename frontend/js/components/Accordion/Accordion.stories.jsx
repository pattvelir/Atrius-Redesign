  ...
  <AccordionContainer>
    <AccordionItem title="Vaporware">
      <p>
        ...
        semiotics locavore lumbersexual taxidermy adaptogen austin dreamcatcher
        pinterest. Swag mustache hammock, jean shorts affogato occupy cred lomo
        vinyl. Deep v gochujang cold-pressed artisan. Sartorial listicle you
        probably haven't heard of them chicharrones, asymmetrical kogi affogato
        thundercats PBR&B irony gastropub keffiyeh shoreditch ethical.
      </p>
    </AccordionItem>
    <AccordionItem title="tattooed trust fund">
      <p>
      ...
      <p>
        ...
        big mood DSA +1 freegan. La croix tacos polaroid four loko, fit coloring
        book organic. Migas cray squid palo santo shaman ugh knausgaard meggings
        pitchfork organic authentic venmo mixtape godard. Aesthetic chillwave
        authentic, pug taiyaki 3 wolf moon shaman gastropub try-hard four loko.
        Tousled af trust fund taxidermy fashion axe deep v craft beer DIY tofu
        tacos tonx vice green juice PBR&B jean shorts.
      </p>
    </AccordionItem>
  </AccordionContainer>
);
