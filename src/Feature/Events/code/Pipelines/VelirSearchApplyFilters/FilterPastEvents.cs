...
namespace AtriusHealth.Feature.Events.Pipelines.VelirSearchApplyFilters
{
	public class FilterPastEvents : AbstractVelirSearchQueryProcessor<AtriusHealthSearchResultItem>
	{
