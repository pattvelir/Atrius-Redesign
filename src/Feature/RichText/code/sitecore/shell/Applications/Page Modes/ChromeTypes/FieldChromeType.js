Sitecore.PageModes.ChromeTypes.Field = Sitecore.PageModes.ChromeTypes.ChromeType.extend({
    ...
    refreshValue: function () {
        ...
        if (this.contentEditable()) {
			...
			this.chrome.element[0].outerHTML = this.fieldValue[0].defaultValue.replace(/"/g, '\'');;
		}
    ...
    isLinkSelected: function () {
        ...
        return  node != null && (
                ...
                node.parentNode.parentElement.tagName === "A" ||
                node.parentNode.parentElement.parentElement.tagName === "A" ||
                node.parentNode.parentElement.parentElement.parentElement.tagName === "A");
    },
    ...
    editControl: function (itemid, language, version, fieldid, controlid, message) {
		...
		/** BEGIN: AtriusHealth UPDATE FOR Placeholders in RTE **/
        ...
        /** END: AtriusHealth UPDATE FOR Placeholders in RTE **/
    ...
    _tryUpdateFromWatermark: function () {
        ...
        if (this.fieldValue[0] !== undefined) {
            ...
            if (this.watermarkHTML &&
                ...
                defaultValue.trim().indexOf('<iframe') === -1 &&
