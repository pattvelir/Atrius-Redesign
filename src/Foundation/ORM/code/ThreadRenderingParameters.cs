...
{
	public class ThreadRenderingParameters : RenderingParameters
	{
		public ThreadRenderingParameters() : base(string.Empty)
		{

		}
		public ThreadRenderingParameters(string parametersAsQueryString) : base(parametersAsQueryString)
		{
