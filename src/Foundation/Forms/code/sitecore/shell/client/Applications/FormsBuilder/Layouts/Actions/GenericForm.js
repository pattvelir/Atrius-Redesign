    ...
    function (_) {
      return {
        initialized: function () {
          ...
          this.MapGenericForm.children.forEach(function (control) {
        ...
        setDynamicData: function (propKey) {
          var componentName = this.MapGenericForm.bindingConfigObject[propKey].split(".")[0];
          var component = this.MapGenericForm[componentName];
        ...
        loadDone: function (parameters) {
          ...
          _.keys(this.MapGenericForm.bindingConfigObject).forEach(this.setDynamicData.bind(this));
          this.MapGenericForm.BindingTarget = this.Parameters;
        },

        getData: function () {
          var formData = this.MapGenericForm.getFormData(),
