    ...
    <input id="ErrorText" runat="server" type="hidden" value="" />
          ...
          <tr>
            ...
            <td valign="top" width="100%">
              ...
              <div id="FileListWrapper">
                ...
                <div id="FileList">
                    <input id="File0" multiple="true" name="File0" type="file" value="browse" onchange="javascript:return Sitecore.Upload.change(this)"/>
                </div>
              </div>
        ...
        <div id="OptionTableWrapper">
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td runat="server" id="OverwriteCell" colspan="2">
